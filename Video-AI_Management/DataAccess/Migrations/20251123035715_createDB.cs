        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecognizedCelebrities = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CelebrityFrames = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsBlurActivated = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
